...
FAKE_VALUE_FUNC(dict_c*, dict_create_u64, size_t, u32)
...
FAKE_VALUE_FUNC(dict_c*, dict_create_str, size_t, u32)
...
static void fake__cex__cexlib__dict__resetall(void) {
    ...
    RESET_FAKE(dict_create_u64)
    RESET_FAKE(dict_create)
    RESET_FAKE(dict_create_str)
    RESET_FAKE(dict_set)
